        ...
        <div className="space-y-10 text-gray-600 text-sm leading-relaxed">
          <section>
            ...
            <p>
              ...
              <span className="text-gray-800">appfra.me</span>. This Privacy Policy explains what information we collect,
          ...
          <section>
            ...
            <h3 className="text-gray-800 font-medium mb-2">Payment information</h3>
            <p className="mb-4">
            ...
            <h3 className="text-gray-800 font-medium mb-2">Local storage</h3>
            <p className="mb-4">
            ...
            <h3 className="text-gray-800 font-medium mb-2">Analytics</h3>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5">
              <li><span className="text-gray-800">Google OAuth</span> — for authentication (<a href="https://policies.google.com/privacy" className="underline hover:text-gray-800 transition-colors" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a>)</li>
              <li><span className="text-gray-800">Stripe</span> — for payment processing (<a href="https://stripe.com/privacy" className="underline hover:text-gray-800 transition-colors" target="_blank" rel="noopener noreferrer">Stripe Privacy Policy</a>)</li>
              <li><span className="text-gray-800">PureAnalytics</span> — for anonymous analytics (no personal data collected)</li>
              <li><span className="text-gray-800">Apple iTunes API</span> — app data and images are fetched from Apple&apos;s public API and proxied through our server</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">6. Image Proxying</h2>
            <p>
