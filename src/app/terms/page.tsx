      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 pt-24 pb-20">
        ...
        <div className="space-y-10 text-white/60 text-sm leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using AppFrame at <span className="text-white/80">appfra.me</span> (&quot;the Service&quot;),
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">4. Free and Pro Tiers</h2>
            <p className="mb-3">
              AppFrame offers two tiers:
            </p>
            <ul className="list-disc list-inside space-y-1.5 mb-3">
              <li><span className="text-white/80">Free</span> — Unlimited showcase image creation. Downloads include a small &quot;@AppFrame&quot; watermark.</li>
              <li><span className="text-white/80">Pro ($5 one-time)</span> — Removes the watermark from all downloads. This is a one-time payment with lifetime access.</li>
            </ul>
            <p>
          ...
          <section>
            ...
            <h3 className="text-white/80 font-medium mb-2">Generated images</h3>
            <p className="mb-4">
            ...
            <h3 className="text-white/80 font-medium mb-2">App data and icons</h3>
            <p className="mb-4">
            ...
            <h3 className="text-white/80 font-medium mb-2">AppFrame branding</h3>
            <p>
