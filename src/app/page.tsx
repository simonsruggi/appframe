      ...
      <div className="relative z-10 border-t border-gray-200 bg-gray-50 py-10">
        <div className="max-w-4xl mx-auto px-4 flex flex-col items-center gap-4">
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            ...
            <span>by <a href="https://simoneruggiero.com?utm_source=appframe&utm_medium=footer" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">Simone Ruggiero</a></span>
          </div>
